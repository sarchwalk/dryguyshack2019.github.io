 ...
 * In your MainActivity.java file:
 ...
 private RoombaOI roombaOIObj;

//In a method: 
 deletThis = new RoombaOI(this);
 
 * In your main folder, make an assets folder. put all opcode textfiles in there.
 */
...
public class RoombaOI
{
	...
	public String viewOpCodeSingleLine()
	{
	...
	public RoombaOI(Context context)
	{
		opCodeList = new ArrayList<OpCodeLine>();
	...
	public void loadOpCodesAndroid()
	{
		...
		try
		{
			InputStream is = am.open(opCodeFileName);
		...
		System.out.println("AROOGA" + totalLine);

		Scanner stringScanner = new Scanner(totalLine).useDelimiter(";|\\r\\n");;
		while(stringScanner.hasNext())
		{
			String opCodeLineStr = stringScanner.next();
			String opCodeLineCommentStr = stringScanner.next();
